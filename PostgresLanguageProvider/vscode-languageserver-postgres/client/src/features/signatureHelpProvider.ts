...
export default class PostgresqlSignatureHelpProvider implements SignatureHelpProvider {
	...
	public provideSignatureHelp(document: TextDocument, position: Position, token: CancellationToken): Promise<SignatureHelp> {
		...
		let signatureInfo = FunctionsInfoDb.GetSignatureInfo(funName);
...
export class FunctionsInfoDb 
{
    private funcSignatures : {[funName:string]:SignatureInformation;} ={};
    private static mainInstance : FunctionsInfoDb;
    constructor()
    {
        let rawInfo = this.GetRawInfo();
        ...
        for (var funcIdx = 0; funcIdx < rawInfo.length; funcIdx++) {
            ...
            let signatureInfo = new SignatureInformation(element[0].trim(), element[1].trim());
    ...
    public static GetSignatureInfo(funcName:string) : SignatureInformation
    {
    ...
    protected DoGetSignatureInfo(funcName:string) : SignatureInformation
    {
