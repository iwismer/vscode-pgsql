...
export default class PostgresqlSignatureHelpProvider implements SignatureHelpProvider {
	...
	public provideSignatureHelp(document: TextDocument, position: Position, token: CancellationToken): Promise<SignatureHelp> {
		...
		let signatureInfo = new SignatureInformation(funName + "(ParamA int, ParamB char)", "desc1");
        
        signatureInfo.parameters.push({ label: "ParamA", documentation: 'desc1 a'});
        signatureInfo.parameters.push({ label: "ParamB", documentation: 'desc1 b'});
